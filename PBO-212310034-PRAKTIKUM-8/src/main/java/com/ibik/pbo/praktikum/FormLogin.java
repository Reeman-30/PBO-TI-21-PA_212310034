...
public class FormLogin extends JFrame implements ActionListener {
    ...
    private String email = "rayyanpratama30@gmail.com";
    private String pass = "212310034";
    ...
    private Boolean IsDataValid() {
        return (
            txt_email.getText().equals(email) && new String(pass_password.getPassword()).equals(pass)
        );
    }
}
